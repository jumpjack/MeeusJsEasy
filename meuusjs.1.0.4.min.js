...
Math.asin(d*g+e*f*c))},eqToHz:function(a,b,c,t){c=c-b.lng-a.ra;var d=Math.cos(c),e=Math.sin(b.lat);b=Math.cos(b.lat);var f=Math.sin(a.dec);a=Math.cos(a.dec);var addAz=0;if(typeof t !== 'undefined'){if((t==="N")||(t==="n")){addAz=Math.PI;}else{addAz=0}}return new A.HzCoord(Math.atan2(Math.sin(c),d*e-f/a*b)+addAz,Math.asin(e*f+b*a*d))}};A.DeltaT={jdToJde:function(a,b){b||(b=A.DeltaT.estimate(a));return a+b/86400},jdeToJd:function(a,b){b||(b=A.DeltaT.estimate(a));return a-b/86400},decimalYear:function(a){a=A.JulianDay.jdToCalendar(a);return a.y+(a.m-.5)/12},estimate:function(a){var b=A.DeltaT.decimalYear(a);a=Math.pow;return-500>b?-20+32*a((b-1820)/100,2):500>b?(b/=100,10583.6-1014.41*b+33.78311*a(b,2)-5.952053*a(b,3)-.1798452*a(b,4)+.022174192*a(b,5)+.0090316521*a(b,6)):1600>b?(b=(b-1E3)/100,1574.2-556.01*b+71.23472*a(b,2)+.319781*

...
A.Coord = {
	...
	/**
	 * DMSToDeg converts from parsed sexagesimal angle components to decimal degrees.  ****DEPRECATED, USE DMSToDec****
	 *
	 * @function dmsToDeg
	 * @static
	 *
	...
	/**
	 * Returns radian value from an angle.  ****DEPRECATED, USE degToRad ****
	 *
	 * @function calcAngle
	 * @static
	 *
	...
	/**
	 * DMSToDec converts from parsed sexagesimal angle components to decimal degrees.
	 *
	 * @function dmsToDec
	 * @static
	 *
	 ...
	 */
	degToRad: function(neg, d, m, s) {
		return A.Coord.dmsToDec(neg, d, m, s) * Math.PI / 180;
	},
	...
	calcRA: function(h, m, s) {
		var r = A.Coord.dmsToDec(false, h, m, s) % 24;
	...
	/**
	 * EqToHz computes Horizontal coordinates (Alt/Az)  from equatorial coordinates (RA/dec). <br>
	 ...
	 */
	eqToHz: function(eqcoord, eclCoord, strad, typeOfAzimuth)  {
